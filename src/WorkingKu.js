      ...
      return (
          <div className="WorkInOut">
            <div className="WorkSheet">
              ...
              <p>
                <p1>
                  {nowDate[3]}/{month}/{nowDate[2]}
                </p1>
                <p2>
                  {curHMS[0]}:{curHMS[1]}:{curHMS[2]}
                </p2>
                <br/>
                <br/>
                <p3>근로장학생 '{User_name}'</p3>
                <br/>
                <p4>- 근무지 정보통신처</p4>
                <br/>
                <p4>- 모시깽</p4>
      ...
      return (
          <div className="WorkInOut">
            <div className="WorkOutSheet">
              <p>
                <p11>출근 시간</p11>
                <p21>{WorkInTime[4]}</p21>
              </p>
              <br/>
              <p>
                <p12>퇴근 시간</p12>
                <p22>{WorkOutTime[4]}</p22>
              </p>
              <br/>
              <p>
                <p13>근무 시간</p13>
              ...
              <div className="WorkOutsubButton">
                <button onClick={gohome}>로그아웃</button>
                <button onClick={goMemo}>메모장</button>
              </div>
            </div>
            <div className="WorkList">
              <p>
