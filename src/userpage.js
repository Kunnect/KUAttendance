...
// 결과를 "hh:mm" 형식으로 포맷팅
var diffString = hours.toString().padStart(2, "0") + "h " + minutes.toString().padStart(2, "0")+"m";
    ...
    return (
        <div className="mypage">
            ...
            <div id="userInfo">
                    ...
                    <img id="userImg" src="/img/userImg.jpeg" height="100px" width="100px"></img>
           
                
                <div id="userText">{username} <br></br> {userinfo}</div>
            </div>
